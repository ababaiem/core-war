...
./corewar-test $FLAGS ./champs_for_our_project/$CHAMP > 2.txt
...
./corewar-test $FLAGS ./champs_for_our_project/$CHAMP1 ./champs_for_our_project/$CHAMP2 > 2.txt
echo Diff 2 1 ============================================
diff -u 1.txt 2.txt
echo Diff 2 1 end ============================================
...
./corewar-test $FLAGS ./champs_for_our_project/$CHAMP1 ./champs_for_our_project/$CHAMP2 ./champs_for_our_project/$CHAMP3 > 2.txt
echo Diff 3 1 ============================================
diff -u 1.txt 2.txt
echo Diff 3 1 end ============================================
